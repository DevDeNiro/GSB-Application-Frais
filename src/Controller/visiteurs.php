...
class visiteurs extends AbstractController
{
    ...
    public function Saisir_frais(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('ajoutFrais', 'Frais forfaitaire ajouté avec succès!');
    ...
    public function Saisir_frais_2(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('ajoutFrais', 'Frais hors forfait ajouté avec succès!');
            return $this->redirectToRoute('accueil_visiteurs');
        }
    ...
    public function suprAuForfait(int $id): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route("/supprimer2/{id}", name = "delHorsForfait")
     */

    public function suprHorsForfait(int $id): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route("/remplacementVehicule/{id}", name = "cancelNewCar")
     */

    public function cancelVehicule(int $id): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route("/changementVehicule/{id}", name = "dropCar")
     */

    public function changementVehicule(int $id): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
        ...
        $this->addFlash('dropCar', 'Votre nouvelle voiture a été ajoutée avec succès.');
        return $this->redirectToRoute('vehicule');
    }

    /**
     * @Route("/supprimer6/{id}", name = "annulerRemplacement")
     */

    public function annulerRemplacementVehicule(int $id): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    public function remplacement_vehicule(int $id): Response
    {
        $repository = $this->getDoctrine()
            ->getRepository(Vehicule::class)
    ...
    public function modifier_auForfait(Request $request, int $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('updateAuForfait', 'Frais forfaitaire modifié avec succès!');
    ...
    public function remplacementSuppression1(int $id): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    public function modifier_horsForfait(Request $request, int $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('updateHorsForfait', 'Frais hors forfait modifié avec succès!');
    ...
    public function remplacementSuppression2(int $id): Response
    {
